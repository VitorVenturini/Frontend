...
export default function UserButton({ button, handleClick }: ButtonProps) {
  ...
  const commonClasses = `w-[128px] h-[55px] md:w-[128px] md:h-[55px]  lg:w-[128px] lg:h-[55px]  xl:w-[128px] xl:h-[55px] 2xl:w-[150px] 2xl:h-[80px] rounded-lg border bg-border text-white shadow-sm p-1 ${statusClass} `;
  return (
    <div
