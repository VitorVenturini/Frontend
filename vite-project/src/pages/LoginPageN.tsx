  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        data.isLogged = localStorage.getItem("isLogged");
        data.isAdmin = localStorage.getItem("isAdmin");
        console.log(data);

        console.log(
          "isLogged setado para true?" + localStorage.getItem("isLogged")
        );
        console.log("Tipo de usuário:", data.type);

        console.log("redirecionando para a página de administração ou usuário");
        console.log("isAdmim", isAdmin);
